...
//https://www.bennadel.com/blog/3725-positioning-and-constraining-a-fixed-position-element-relative-to-an-absolute-positioned-element-in-angular-9-0-0-rc-2.htm
//https://jqueryui.com/position/
@Component({
  selector: 'lib-keyboard-v3',
  templateUrl: './keyboard-v3.component.html',
  styleUrls: ['./keyboard-v3.component.css']
})
export class KeyboardV3Component implements OnInit, AfterViewInit {
 ...
 */
  ...
  constructor(private renderer: Renderer2, private keyboardEventsService: KeyboardEventsService) {
